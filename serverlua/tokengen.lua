-- see http://www.redisgreen.net/blog/2013/03/18/intro-to-lua-for-redis-programmers/
...
if ex == 1 then
	...
	redis.call('HMSET', key, 'consumer_key', conkey, 'consumer_secret', consecret, 'token_secret', token_secret, 'cltimestamp', time)
	-- testing purpose
